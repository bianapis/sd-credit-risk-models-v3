...
/**
 * BQTestingRequestOutputModel
 */
public class BQTestingRequestOutputModel   {
  ...
  private String testingRequestActionTaskReference = null;

  private Object testingRequestActionTaskRecord = null;

  private String testingRequestRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Testing instance request service call 
   * @return testingRequestActionTaskReference
  **/

  public String getTestingRequestActionTaskReference() {
    return testingRequestActionTaskReference;
  }

  public void setTestingRequestActionTaskReference(String testingRequestActionTaskReference) {
    this.testingRequestActionTaskReference = testingRequestActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The request service call consolidated processing record 
   * @return testingRequestActionTaskRecord
  **/

  public Object getTestingRequestActionTaskRecord() {
    return testingRequestActionTaskRecord;
  }

  public void setTestingRequestActionTaskRecord(Object testingRequestActionTaskRecord) {
    this.testingRequestActionTaskRecord = testingRequestActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Testing service request record 
   * @return testingRequestRecordReference
  **/

  public String getTestingRequestRecordReference() {
    return testingRequestRecordReference;
  }

  public void setTestingRequestRecordReference(String testingRequestRecordReference) {
    this.testingRequestRecordReference = testingRequestRecordReference;
  }
