...
/**
 * BQTestingCaptureOutputModel
 */
public class BQTestingCaptureOutputModel   {
  ...
  private String testingCaptureActionTaskReference = null;

  private Object testingCaptureActionTaskRecord = null;

  private String testingCaptureRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Testing instance capture service call 
   * @return testingCaptureActionTaskReference
  **/

  public String getTestingCaptureActionTaskReference() {
    return testingCaptureActionTaskReference;
  }

  public void setTestingCaptureActionTaskReference(String testingCaptureActionTaskReference) {
    this.testingCaptureActionTaskReference = testingCaptureActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The capture service call consolidated processing record 
   * @return testingCaptureActionTaskRecord
  **/

  public Object getTestingCaptureActionTaskRecord() {
    return testingCaptureActionTaskRecord;
  }

  public void setTestingCaptureActionTaskRecord(Object testingCaptureActionTaskRecord) {
    this.testingCaptureActionTaskRecord = testingCaptureActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Testing structured input transaction/record 
   * @return testingCaptureRecordReference
  **/

  public String getTestingCaptureRecordReference() {
    return testingCaptureRecordReference;
  }

  public void setTestingCaptureRecordReference(String testingCaptureRecordReference) {
    this.testingCaptureRecordReference = testingCaptureRecordReference;
  }
